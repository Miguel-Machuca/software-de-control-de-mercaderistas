...
function ActualizarOrdenTrabajoDemostracion(props) {
  ...
  return (
      <OrdenTrabajoDominio>
          {({ handleActualizar, handleChange, ordenTrabajo, clientes, sucursales, mercaderistas }) => (
              <>
                  <Sidebar />
...
export default ActualizarOrdenTrabajoDemostracion