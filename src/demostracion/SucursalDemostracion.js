...
function SucursalDemostracion(props) {
  return (
    <SucursalDominio>
        {({
            sucursal,
            ...
            <div className="relative md:ml-64 bg-blueGray-100">
              ...
              {/* Header */}
              <HeaderStats buttonText="Registrar Sucursal" onClick={handleFormulario} showButton={true} />
...
export default SucursalDemostracion