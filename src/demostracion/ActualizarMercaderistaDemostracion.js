...
function ActualizarMercaderistaDemostracion(props) {
  const { id } = useParams();

  return (
    <MercaderistaDominio>
      {({ handleActualizar, handleChange, mercaderista }) => (
        <>
          <Sidebar />
                        ...
                        <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                          <form onSubmit={handleActualizar}>
                            <div className="flex flex-wrap">
                              ...
                              <div className="w-full lg:w-6/12 px-4">
                                <div className="relative w-full mb-3">
                                  <label className="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlFor="grid-telefono">
                                    Telefono
                                  </label>
                                  <input
                                    type="text"
                              ...
                              <div className="w-full lg:w-6/12 px-4">
                                <div className="relative w-full mb-3">
                                  <label className="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlFor="grid-ci">
                                    Cedula de Identidad
                                  </label>
                                  <input
                                    type="text"
                              ...
                              <div className="w-full lg:w-6/12 px-4">
                                <div className="relative w-full mb-3">
                                  <label className="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlFor="grid-fecha_nacimiento">
                                    Fecha de Nacimiento
                                  </label>
                                  <input
                                    type="date"
                              ...
                              <div className="w-full lg:w-6/12 px-4">
                                <div className="relative w-full mb-3">
                                  <label className="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlFor="grid-direccion">
                                    Dirección
                                  </label>
                                  <input
                                    type="text"
                              ...
                              <div className="w-full lg:w-6/12 px-4">
                                <div className="relative w-full mb-3">
                                  <label className="block uppercase text-blueGray-600 text-xs font-bold mb-2" htmlFor="grid-equipo">
                                    Equipo
                                  </label>
                                  <input
                                    type="text"
...
export default ActualizarMercaderistaDemostracion;
