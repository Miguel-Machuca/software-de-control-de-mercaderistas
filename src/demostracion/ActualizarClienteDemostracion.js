...
function ActualizarClienteDemostracion(props) {
  const { id } = useParams();

  return (
    <ClienteDominio>
      {({ handleActualizar, handleChange, cliente }) => (
        <>
          <Sidebar />
...
export default ActualizarClienteDemostracion;
